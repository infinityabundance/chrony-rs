...
- **chrony-rs native inventory (`syn` AST):** 835 named functions + 159 closures across 63 `.rs` files. Extracted from the real AST, not doxygen — see the limitation notice in `docs/port-parity.md`.

...
use crate::ntp::ext::{parse_field, NtpPacketBuf, NtpPacketInfo, NTP_HEADER_LENGTH, NTP_MAX_V4_MAC_LENGTH};

/// chrony auth modes (`NTP_AuthMode`).
const NTP_AUTH_NONE: i32 = 0;
const NTP_AUTH_SYMMETRIC: i32 = 1;
const NTP_AUTH_MSSNTP: i32 = 2;
const NTP_AUTH_MSSNTP_EXT: i32 = 3;
const NTP_AUTH_NTS: i32 = 4;
